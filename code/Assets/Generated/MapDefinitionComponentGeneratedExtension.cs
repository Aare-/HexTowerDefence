...
namespace Entitas {
    public partial class Entity {
        public MapDefinitionComponent mapDefinition { get { return (MapDefinitionComponent)GetComponent(ComponentIds.MapDefinition); } }

        public bool hasMapDefinition { get { return HasComponent(ComponentIds.MapDefinition); } }

        static readonly Stack<MapDefinitionComponent> _mapDefinitionComponentPool = new Stack<MapDefinitionComponent>();
        ...
        public Entity AddMapDefinition(int newRadius, float newChanceOfBlockedTile) {
            var component = _mapDefinitionComponentPool.Count > 0 ? _mapDefinitionComponentPool.Pop() : new MapDefinitionComponent();
    ...
    public partial class Pool {
        ...
        public MapDefinitionComponent mapDefinition { get { return mapDefinitionEntity.mapDefinition; } }
